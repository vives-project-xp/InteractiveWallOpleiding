...
In [deze](./Code/README.md) map vindt je meer informatie over de gebruikte code in ons project.  
In [deze](./Documentatie/README.md) map vindt je alle nodige documentatie om ons project zelf op te kunnen zetten.  
In [deze](./Technisch/README.md) map vindt je technische schema's en architecturen

## Team

| Team | Afstudeerrichting |
| ---- | ----------------- |
| Maxime Coen | Software |
