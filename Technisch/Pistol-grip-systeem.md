# Pistol-grip Systeem - Interactive Wall

Dit document beschrijft de volledige fysieke constructie van de standaardopstelling met de pistol-grip (one-hand clutch). Hier vind je alle informatie die nodig is om het frame en de fysieke componenten zelf te bouwen.
